...
export default function FormCodeExample({ formSlug, className = "" }: FormCodeExampleProps) {
  return <div className={clsx("mockup-code sm:shadow-md", className)}>
    <pre data-prefix=" 1"><code>{'<'}<span className="text-red-400">form</span> <span className="text-orange-300">action</span>=<span className="text-green-300">"https://formidable.site/<em>{formSlug}</em>"</span>{'>'}</code></pre>
